...
!
!   This unit test checks a - b - c = d across MPI boundaries. The small
!   parcels 'a' and 'b' should want to merge and 'c' and 'd'.
! =============================================================================
program test_mpi_nearest_16
    ...
    !
    ! Test 2: a - b - c = d; corner setup (180 degree rotation of test 1)
    !
    call parcel_setup(2)
    ...
    !
    ! Test 3: a - b - c = d; corner setup (mirrored of test 1)
    !
    call parcel_setup(3)
    ...
    !
    ! Test 5: a - b - c = d with b = c across MPI boundary
    !
    call parcel_setup(5)
    ...
    contains
        ...
        ! a - b - c = d; corner setup (180 degree rotation of test 1)
        ...
        ! a - b - c = d; corner setup (mirrored of test 1)
        ...
        ! a - b - c = d with b - c across MPI boundary
...
end program test_mpi_nearest_16
