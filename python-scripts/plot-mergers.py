...
def show_frames(h5merger, h5mergee, h5neighbours):
    def draw(ax, lam=None):
        ...
        ax.axhline(
            get_position(origin[1], iz, dx[1]),
            color="black",
            linestyle="dashed",
            linewidth=0.75,
        )
        ax.axhline(
            get_position(origin[1], iz + 1, dx[1]),
            color="black",
            linestyle="dashed",
            linewidth=0.75,
        )
        ...
        ax.axvline(
            get_position(origin[0], ix, dx[0]),
            color="black",
            linestyle="dashed",
            linewidth=0.75,
        )
        ax.axvline(
            get_position(origin[0], ix + 1, dx[0]),
            color="black",
            linestyle="dashed",
            linewidth=0.75,
        )
        ...
        ax.legend(
            [ell_merger[0], ell_mergee[0], ell_mergees[0]],
            [r"merger", r"mergees", r"others"],
            loc="upper center",
            ncol=3,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mergers", type=str, required=True, help="*_merger.hdf5 output file of EPIC"
    )

    parser.add_argument(
        "--mergees", type=str, required=True, help="*_mergee.hdf5 output file of EPIC"
    )
