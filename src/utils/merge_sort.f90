...
module merge_sort
    ...
    private :: dmergesort, dmerging, imergesort, imerging
    ...
    contains
        ...
        subroutine dmsort(a, ai)
            ...
            call dmergesort(a, ai, 1, m)

        end subroutine dmsort

        recursive subroutine dmergesort(a, ai, l, r)
            double precision, intent(inout) :: a(:)
            ...
            if (l < r) then
                ...
                call dmergesort(a, ai, l, m)
                call dmergesort(a, ai, m + 1, r)

                call dmerging(a, ai, l, m, r)
            endif
        end subroutine dmergesort

        subroutine dmerging(a, ai, l, m, r)
            double precision, intent(inout) :: a(:)
            integer,          intent(inout) :: ai(:)
