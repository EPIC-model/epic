...
module options
    ...
    type time_info_type
        ...
        double precision :: alpha_s     = 0.05d0     ! factor for adaptive time stepping with strain
        double precision :: alpha_b     = 0.05d0     ! factor for adaptive time stepping with buoyancy gradient
