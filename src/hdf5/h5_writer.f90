    ...
    contains
        ...
        subroutine write_h5_options(h5file_id)
            ...
            call create_h5_group(gopts, "parcel", group)
                ...
                call write_h5_double_scalar_attrib(group, "vmin_fraction", parcel%vmin_fraction)
                ...
                call write_h5_double_scalar_attrib(group, "vmax_fraction", parcel%vmax_fraction)
            call close_h5_group(group)
            ...
            call create_h5_group(gopts, "output", group)
                ...
                call write_h5_int_scalar_attrib(group, "h5_diagnostics_freq", output%h5_diagnostics_freq)
            ...
            call create_h5_group(gopts, "time", group)
                ...
                call write_h5_double_scalar_attrib(group, "alpha_s", time%alpha_s)
                call write_h5_double_scalar_attrib(group, "alpha_b", time%alpha_b)
