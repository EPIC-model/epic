...
module options
    ...
    type parcel_type
        ...
        double precision :: min_lratio       = 40.0d0   ! minimum ratio of grid cell width / parcel length
        double precision :: max_lratio       = 1.5d0    ! maximum ratio of grid cell width / parcel length
    ...
    contains
        ...
        subroutine write_netcdf_options(ncid)
            ...
            call write_netcdf_attribute(ncid, "min_lratio", parcel%min_lratio)
            call write_netcdf_attribute(ncid, "max_lratio", parcel%max_lratio)
