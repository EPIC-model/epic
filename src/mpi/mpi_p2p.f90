module mpi_p2p
    ...
    contains
        ...
        subroutine mpi_double_isend(data, dest, tag)
            ...
            call MPI_Isend(data, size(data), MPI_DOUBLE_PRECISION, dest, tag, comm_world, request, mpi_err)
        ...
        subroutine mpi_integer_isend(data, dest, tag)
            ...
            integer, intent(in)               :: tag
            type(MPI_Request)                 :: request
            call MPI_Isend(data, size(data), MPI_INT, dest, tag, comm_world, request, mpi_err)
        ...
        subroutine mpi_double_irecv(data, source, tag)
            ...
            integer,          intent(in)                :: tag
            type(MPI_Request)                           :: request
            call MPI_Irecv(data, size(data), MPI_DOUBLE_PRECISION, source, tag, comm_world, request, mpi_err)
        ...
        subroutine mpi_integer_irecv(data, source, tag)
            ...
            integer, intent(in)                :: tag
            type(MPI_Request)                  :: request
            call MPI_Irecv(data, size(data), MPI_INT, source, tag, comm_world, request, mpi_err)
        ...
        subroutine mpi_double_send(data, dest, tag)
            ...
            integer,          intent(in) :: dest
            integer,          intent(in) :: tag
            call MPI_Send(data, size(data), MPI_DOUBLE_PRECISION, dest, tag, comm_world, mpi_err)
        ...
        subroutine mpi_integer_send(data, dest, tag)
            ...
            integer, intent(in) :: dest
            integer, intent(in) :: tag
            call MPI_Send(data, size(data), MPI_INT, dest, tag, comm_world, mpi_err)
        ...
        subroutine mpi_double_recv(data, source, tag)
            ...
            call MPI_Recv(data, size(data), MPI_DOUBLE_PRECISION, source, tag, comm_world, status, mpi_err)
        ...
        subroutine mpi_integer_recv(data, source, tag)
            ...
            integer, intent(in)  :: tag
            type(MPI_Status)     :: status
            call MPI_Recv(data, size(data), MPI_INT, source, tag, comm_world, status, mpi_err)
