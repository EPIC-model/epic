...
module classic_rk4
    ...
    contains
        ...
        subroutine classic_rk4_elliptic(dt)
            ...
            call grid2par(parcels%position, parcels%volume, k1o, velocity_f, parcels%B, &
                          exact='velocity', recache=.true.)
            ...
            call grid2par(parcels%position, parcels%volume, k2o, velocity_f, parcels%B, &
                          exact='velocity', recache=.true.)
            ...
            call grid2par(parcels%position, parcels%volume, k3o, velocity_f, parcels%B, &
                          exact='velocity', recache=.true.)
            call grid2par(parcels%position, parcels%volume, strain, strain_f, parcels%B, exact='strain')
            ...
            call grid2par(parcels%position, parcels%volume, k4o, velocity_f, parcels%B, &
                          exact='velocity', recache=.true.)
            call grid2par(parcels%position, parcels%volume, strain, strain_f, parcels%B, exact='strain')
        ...
        subroutine classic_rk4_non_elliptic(dt)
            ...
            inipos = parcels%position

            call grid2par(parcels%position, parcels%volume, k1o, velocity_f, &
                          exact='velocity', recache=.true.)
            ...
            call grid2par(parcels%position, parcels%volume, k2o, velocity_f, &
                          exact='velocity', recache=.true.)
            ...
            call grid2par(parcels%position, parcels%volume, k3o, velocity_f, &
                          exact='velocity', recache=.true.)
            ...
            call grid2par(parcels%position, parcels%volume, k4o, velocity_f, &
                          exact='velocity', recache=.true.)
